...
export const ZONE_META: Record<ZoneLevel, IERZone> = {
  A: { level: 'A', color: 'green', label: 'Safe',     min: 0,  max: 34  },
  B: { level: 'B', color: 'blue',  label: 'Moderate', min: 35, max: 59  },
  C: { level: 'C', color: 'amber', label: 'Risky',    min: 60, max: 79  },
  D: { level: 'D', color: 'red',   label: 'Critical', min: 80, max: 100 },
};
